...
zero training debt. Its original header verifies the unchanged source/package,
recipe, disjoint live RNG range and zero starting counters without a restore.
An independent CPU read reproduces the
[complete accounting](../../runs/boxing-confirmation-20260910.hTEDcu/seed3019-train.accounting.json),
command exit/output hashes and final save identity. All **241 saved entries**
and **49,651 consecutive learner reports** are finite. Current native layouts,
complete optimizer moments/counters, return normalizers and actual encoder
identity pass. The closed training log's SHA-256 is
`e35a480dc1646fed0840a2c48d72cc242dcf35b59cf274f47c9e9713e0814cf3`.

All **93,394 raw GPU samples** reproduce the
[full training coverage check](../../runs/boxing-confirmation-20260910.hTEDcu/seed3019-train.gpu.json):
minimum directly free memory **3,302 MiB**, maximum sample gap **0.268 s** and
mean activity **69.00%**. All 429 experiment and 756 handoff pins reverify.
The training loop took **23,313.08 s**, reaching **8.5790 actions/s, 0.5718×
aggregate real time**, about 0.0953× per stream. This is not a matched speedup
or a frozen-competence result.

The declared final frozen evaluation finished normally at **00:10:02 UTC on
September 11**. Its complete 75,000-action ledger has **51/51 natural wins,
mean +83.5294, no cutoffs and zero updates**, passing the unchanged gate.
An independent CPU audit reproduces the entire
[score](../../runs/boxing-confirmation-20260910.hTEDcu/seed3019-evaluation.score.json)
and [replay binding](../../runs/boxing-confirmation-20260910.hTEDcu/seed3019-evaluation.replay.json),
all three actual command exits/output hashes, current complete native state and
both raw GPU windows. The actual restore matches the 200,004/49,651 counters,
all tensor-file hashes and final metadata SHA-256
`9316e8a7f418d98eeaa47a60cfe14459c3759ab1f7e7e9c60616087944b9de2f`.

The [whole stream-0 video](../../runs/boxing-confirmation-20260910.hTEDcu/seed3019-evaluation.mp4)
decodes all **49,982 frames at 60 fps**, including its unfinished tail. Its
SHA-256 is `70e1afab567d0d6bd031bfa40886cd2229c8441f5c77cbf2dce7849f39918ca5`;
the score SHA-256 is `e2ccf4bce2986c1d24ff08085a1435c24be3f8feac84bc536faa3d77a898d67d`.
All **9,896 frozen GPU samples** pass coverage with a maximum gap of **0.267 s**,
at least **3,413 MiB directly free** and mean activity **87.98%**. The frozen
loop reaches **31.1266 actions/s, 2.0745× aggregate real time**, about 0.3457×
per stream. This is frozen inference throughput, not playing plus training.
...
differs in all **31 nonconstant parameter tensors**; the **64 deliberately
constant tensors** match. This verifies distinct initial parameter values,
alongside disjoint declared RNG inputs, not statistical independence by itself.
All three initializer commands and raw GPU windows pass; the third retains
