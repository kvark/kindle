...
3. The [fixed-Tiny Freeway pilot](../runs/tiny-freeway-exposure-20260921.ejKgSH/results.md)
   ...
   **Next confirm fresh roots 1009/2017/3019**, holding the encoder/runtime and
   ...
   A fresh full-budget replacement using the unchanged guard as a systemd user
   service is prepared but awaits an explicit no-retry exception. Seed3019 is
   unstarted; no automatic successor is authorized.
   [Current results/video](../runs/tiny-freeway-confirmation-20260922.tij9QW/results.md).
   Resolve the replacement decision before further GPU work. The qualified package
