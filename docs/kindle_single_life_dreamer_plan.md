...
| Freeway | Fresh Tiny seed1009 passes: final36/36, mean32.9167 versus control0/36, mean0; 1/3 required fresh roots passes; original seed2017 interrupted after host-guard loss; approved fresh replacement training complete, frozen midpoint running. Tiny seed0 passes: midpoint/final means 30.50/33.03, both 36/36 qualifying rounds; untrained control 0/36, mean 0. Historical Large fresh roots fail: means 24.58/22.78/22.47, successes 16/36, 3/36, 5/36. | ≥20 natural rounds, ≥90% reach 25 crossings, mean ≥25, no cutoffs. Confirm the fixed Tiny recipe on fresh roots 1009/2017/3019; seed0 is not reliability. | [Fresh seed1009 final](../runs/tiny-freeway-confirmation-20260922.tij9QW/seed1009/final.mp4), [control](../runs/tiny-freeway-confirmation-20260922.tij9QW/seed1009/untrained.mp4), [fresh-root evidence](../runs/tiny-freeway-confirmation-20260922.tij9QW/results.md), [seed0 pilot/videos](../runs/tiny-freeway-exposure-20260921.ejKgSH/results.md) |
...
3. The [fixed-Tiny Freeway pilot](../runs/tiny-freeway-exposure-20260921.ejKgSH/results.md)
   ...
   **Next confirm fresh roots 1009/2017/3019**, holding the encoder/runtime and
   ...
   completes seed1009 training:400,008 actions/99,652 updates, both checkpoints
   and complete state/moments verified, host guard and six-stream replay passed.
   Frozen midpoint/final each pass36/36 natural rounds, means31.3333/32.9167,
   zero updates/cutoffs; full state/replays/videos pass. The fresh untrained
   control completes36 natural rounds, mean0,0/36 successes, zero updates/cutoffs.
   All five phases and complete pair/state/replay/video checks pass. One of three
   required fresh roots passes. Seed2017 is interrupted at45,714/400,008 actions
   after its host guard disappears; the orphaned native process is stopped at
   22:31 UTC September22. Preserve its incomplete evidence; no valid result.
   [Incident and CPU containment proof](../runs/freeway-guard-interruption-20260922.2xt6tnn_/README.md).
   The user approves one fresh full-budget replacement. It starts23:14 UTC
   September22, retaining the complete400,008-action recipe and200,004 midpoint.
   Replacement training completes September23 at07:15 UTC:400,008 actions /
   99,652 updates in8.005h. Both checkpoints/full state/guard pass; the service
   exits successfully with zero restarts. Its separately declared75,000-action
   frozen midpoint starts07:17 UTC,2h guard bound; final/control are unstarted.
   The unchanged guard is owned by a systemd user service with group cleanup
   and no automatic restart; CPU ownership/cleanup checks pass.
   [Current replacement](../runs/tiny-freeway-seed2017-replacement-20260922.12z27y72/results.md).
   Seed3019 is unstarted; no automatic successor is authorized.
   [Current results/video](../runs/tiny-freeway-confirmation-20260922.tij9QW/results.md).
   Review completed midpoint evidence before final evaluation. The qualified package
   is reused without rebuilding; one root is not three-root reliability.
