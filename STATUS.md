...
Updated: **2026-09-23, 07:17 UTC**. This is the short operational dashboard,
...
versus control0/36. The approved seed2017 replacement finishes training and its frozen midpoint
is running under a systemd service; its interrupted predecessor is preserved. One of three roots passes.**
...
| Running: seed2017 frozen midpoint | Freeway stability on fresh roots 1009/2017/3019 | Seed1009 final **36/36, mean32.92** versus control **0/36, mean0**; complete pair passes. Approved seed2017 replacement completes **400,008 actions/99,652 updates in8.005h**; both checkpoints, full state/moments and guard pass, zero service restarts. Its75,000-action frozen midpoint starts07:17 UTC,2h bound; training replay runs on bounded CPU. Original interrupted run is preserved. **1/3 fresh roots passes.** [Seed1009 results/videos](runs/tiny-freeway-confirmation-20260922.tij9QW/results.md), [current run](runs/tiny-freeway-seed2017-replacement-20260922.12z27y72/results.md). |
...
**Next decision:** review seed2017 midpoint state, replay and gameplay evidence,
then separately declare final-policy evaluation and the matched control.
